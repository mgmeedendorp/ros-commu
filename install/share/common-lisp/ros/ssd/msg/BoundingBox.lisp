...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ssd-msg:<BoundingBox> is deprecated: use ssd-msg:BoundingBox instead.")))

(cl:ensure-generic-function 'x_min-val :lambda-list '(m))
(cl:defmethod x_min-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ssd-msg:x_min-val is deprecated.  Use ssd-msg:x_min instead.")
  (x_min m))

(cl:ensure-generic-function 'y_min-val :lambda-list '(m))
(cl:defmethod y_min-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ssd-msg:y_min-val is deprecated.  Use ssd-msg:y_min instead.")
  (y_min m))

(cl:ensure-generic-function 'x_size-val :lambda-list '(m))
(cl:defmethod x_size-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ssd-msg:x_size-val is deprecated.  Use ssd-msg:x_size instead.")
  (x_size m))

(cl:ensure-generic-function 'y_size-val :lambda-list '(m))
(cl:defmethod y_size-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ssd-msg:y_size-val is deprecated.  Use ssd-msg:y_size instead.")
  (y_size m))
