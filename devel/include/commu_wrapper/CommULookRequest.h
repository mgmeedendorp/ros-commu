...
struct CommULookRequest_
{
  ...
  _camera_info_type camera_info;
   ...
   typedef  ::geometry_msgs::Transform_<ContainerAllocator>  _camera_transform_type;
  _camera_transform_type camera_transform;

   typedef int8_t _look_x_type;
  _look_x_type look_x;

   typedef int8_t _look_y_type;
  _look_y_type look_y;
...
struct MD5Sum< ::commu_wrapper::CommULookRequest_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x223cec46c492e1ceULL;
  static const uint64_t static_value2 = 0xcbd32659317e96afULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::commu_wrapper::CommULookRequest_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.camera_transform);
...
struct Printer< ::commu_wrapper::CommULookRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::commu_wrapper::CommULookRequest_<ContainerAllocator>& v)
  {
    ...
    s << indent << "camera_transform: ";
    s << std::endl;
    Printer< ::geometry_msgs::Transform_<ContainerAllocator> >::stream(s, indent + "  ", v.camera_transform);
    s << indent << "look_x: ";
    Printer<int8_t>::stream(s, indent + "  ", v.look_x);
    s << indent << "look_y: ";
    Printer<int8_t>::stream(s, indent + "  ", v.look_y);
  }
};
