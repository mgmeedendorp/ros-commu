...
class CommULookRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('camera_transform')) {
        this.camera_transform = initObj.camera_transform
      }
      else {
        this.camera_transform = new geometry_msgs.msg.Transform();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [camera_transform]
    bufferOffset = geometry_msgs.msg.Transform.serialize(obj.camera_transform, buffer, bufferOffset);
    // Serialize message field [look_x]
    bufferOffset = _serializer.int8(obj.look_x, buffer, bufferOffset);
    // Serialize message field [look_y]
    bufferOffset = _serializer.int8(obj.look_y, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [camera_transform]
    data.camera_transform = geometry_msgs.msg.Transform.deserialize(buffer, bufferOffset);
    // Deserialize message field [look_x]
    data.look_x = _deserializer.int8(buffer, bufferOffset);
    // Deserialize message field [look_y]
    data.look_y = _deserializer.int8(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return '223cec46c492e1cecbd32659317e96af';
  }
  ...
  static messageDefinition() {
    ...
    geometry_msgs/Transform camera_transform
  ...
  static Resolve(msg) {
    ...
    if (msg.camera_transform !== undefined) {
      resolved.camera_transform = geometry_msgs.msg.Transform.Resolve(msg.camera_transform)
    }
    else {
      resolved.camera_transform = new geometry_msgs.msg.Transform()
    }
...
module.exports = {
  ...
  md5sum() { return 'f140a05a390d4967a567a474c5dfde3f'; },
